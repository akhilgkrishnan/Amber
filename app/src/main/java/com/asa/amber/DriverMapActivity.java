...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, RoutingListener {
    ...
    private TextView mCustomerName, mCustomerPhone, mCustomerPickup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomerPickup = findViewById(R.id.customerPosition);
        ...
        mRideStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                case 1:
                    status = 2;
                    erasePolylines();
                    if (destinationLatLng.latitude != 0.0 && destinationLatLng.longitude != 0.0) {//TODO implement route
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.logout:
                        ...
                        intent = new Intent(DriverMapActivity.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                        return true;
                    default:
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists() && !customerId.equals("")) {
                            ...
                            pickupMarker = mMap
                                    .addMarker(new MarkerOptions().position(pickupLatLng).title("Pickup location")
    ...
    private void getRouteToMarker(LatLng pickupLatLng) {
        if (pickupLatLng != null && mLastLocation != null) {
            Routing routing = new Routing.Builder().travelMode(AbstractRouting.TravelMode.DRIVING).withListener(this)
   ...
   /* private void getAssignedCustomerDestination() {
    ...
    private void endRide() {
        ...
        mCustomerPickup.setText("Destination: --");
    }
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this).setTitle("give permission").setMessage("give permission message")
